...
import {loadNotificationSettings, saveNotificationSettings} from "../tabs/service/SettingsHelper";
            ...
            PushNotification.checkPermissions((result) => {
                ...
                if (!result.alert) {
                    if (Platform.OS === 'ios') {
                        ...
                        Alert.alert("Benachrichtigungen einschalten", "Du musst in den Einstellungen den Versand von Benachrichtigungen erlauben.");
                    }
            ...
            <View>
                <View style={styles.toggleContainer}>
                    ...
                    <Switch
                        ...
                        thumbColor={"#f4f3f4"}
                        onValueChange={(value) => this.changeSettings({notificationsEnabled: value})}
                    ...
                    <View style={styles.switches}>
                        <View style={styles.toggleContainer}>
                            ...
                            <Switch
                                trackColor={{false: dhbwGray, true: dhbwRed}}
                                thumbColor={"#f4f3f4"}
                                onValueChange={(value) => this.changeSettings({notificationdhbwNews: value})}
                        ...
                        <View style={styles.toggleContainer}>
                            ...
                            <Switch
                                trackColor={{false: dhbwGray, true: dhbwRed}}
                                thumbColor={"#f4f3f4"}
                                onValueChange={(value) => this.changeSettings({notificationdhbwEvents: value})}
                        ...
                        {false ? <View style={styles.toggleContainer}>
                            ...
                            <Switch
                                trackColor={{false: dhbwGray, true: dhbwRed}}
                                thumbColor={"#f4f3f4"}
                                onValueChange={(value) => this.changeSettings({notificationschedule: value})}

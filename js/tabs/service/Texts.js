  ...
  return(
    <View style={styles.container}>
      ...
      <View style={styles.block}>
        ...
        <Text style={styles.link}
          onPress={() => Linking.openURL('https://www.dhbw-loerrach.de/mensa.html')}>
    ...
    <View style={styles.container}>
      <View style={styles.block}>
        ...
        <Text style={styles.text}>
          ...
          designten, modernen Food Court mit urbaner Atmosphäre. Täglich wechselnde 
          Gerichte mit Fleisch oder in vegetarischen Varianten, gutbürgerliche und 
          mediterrane Küche, Pizza und Pasta, Gerichte zum Mitnehmen, Snacks, 
          Backwaren, vegane Snacks, Panini, Focacci und vieles mehr bieten für 
      ...
      <View style={styles.block}>
        <Text style={styles.headline}>Preise</Text>
        <Text style={styles.text}>
          Je nach Gericht bezahlen Sie i.d.R. zwischen 3 und 8 Euro. Es wird kein 
          gesonderter Studierendenrabatt gewährt. Die Bezahlung erfolgt in bar oder 
          mit Karte. {'\n'}
        </Text>
        <Text style={styles.link}

...
export function TextCafeteriaKKH() {
  ...
  return (
    <View style={[Styles.Texts.container, {backgroundColor: colorContext.colorScheme.background}]}>
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Cafeteria im KKH</Text>
        ...
        <Text style={{paddingLeft: 20, color: colorContext.colorScheme.text }}>
          • Suppe {'\n'}• Deftig & Würzig {'\n'}• Leicht & Lecker{' '}
          {'\n'}• Vegetarisch & Vital {'\n'}• Dessert {'\n'}•
          Abendessen
        </Text>
      ...
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Ort</Text>
        <Text style={{color: colorContext.colorScheme.text}}>
          Spitalstraße 25
          {'\n'}
          79539 Lörrach
      ...
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Mittagstisch</Text>
        <Text style={{color: colorContext.colorScheme.text}}>
          Montag bis Freitag: 11:30 – 14:00 Uhr
        </Text>
      </View>
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Preise</Text>
        <Text style={{color: colorContext.colorScheme.text}}>
        ...
        <Text style={{color: colorContext.colorScheme.text}}>(ca. 9 Minuten Fußweg) {'\n'}</Text>
        <Text
          style={{color: colorContext.colorScheme.dhbwRed}}
          onPress={() =>
            Linking.openURL(
  ...
  return (
    <View style={[Styles.Texts.container, {backgroundColor: colorContext.colorScheme.background}]}>
      ...
      <View style={[Styles.Texts.block, { flexDirection: 'row' }]}>
        ...
        />
        <Text style={[{color: colorContext.colorScheme.text}, Styles.Texts.quote]}>
          {disclaimerText}
        </Text>
      </View>
      <View style={Styles.Texts.block}>
...
export function TextDisclaimer() {
  const colorContext = useContext(ColorSchemeContext);
  return (
    <View style={[Styles.Texts.block, { marginBottom: 0, backgroundColor: colorContext.colorScheme.background }]}>
      <Text style={{color: colorContext.colorScheme.text}}>{disclaimerText}</Text>
    </View>
  );
}
...
export function TextHieber() {
  ...
  return (
    <View style={[Styles.Texts.container, {backgroundColor: colorContext.colorScheme.background}]}>
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Hieber’s Frische Center</Text>
        <Text style={{color: colorContext.colorScheme.text}}>
      ...
      <View style={Styles.Texts.block}>
        ...
        <Text style={{color: colorContext.colorScheme.text}}>(ca. 140 Meter Fußweg)</Text>
      </View>
    </View>
  );
}
...
export function TextImprint() {
  ...
  return (
    <View style={[Styles.Texts.container, {backgroundColor: colorContext.colorScheme.background}]}>
      ...
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>
      ...
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Externe Links</Text>
        <Text style={{color: colorContext.colorScheme.text}}>
      ...
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Urheberrecht</Text>
        <Text style={{color: colorContext.colorScheme.text}}>
      ...
      <View style={Styles.Texts.block}>
        <Text style={[Styles.Texts.headline, {color: colorContext.colorScheme.text}]}>Quellcode</Text>
        <Text style={{color: colorContext.colorScheme.text}}>
...
export function TextPrivacy() {
  const colorContext = useContext(ColorSchemeContext);
  return (
    <ScrollView style={[Styles.Texts.container, {backgroundColor: colorContext.colorScheme.background}]}>
      <View style={Styles.Texts.block}>
        <Text style={{color: colorContext.colorScheme.text}}>

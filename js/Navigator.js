...
export default function NavigatorDark({ navigation }) {
  ...
  const tabBarLabel = (title,{ focused }) => {
    return(
        <Text style={{color: focused ? colorContext.colorScheme.dhbwRed : colorContext.colorScheme.tabBarText,
          fontSize: 10}}>
          {title}
        </Text>
    )
  ...
  const tabBarIcon = (icon, size, { focused }) => {
    return <FontAwesomeIcon icon={icon} size={size} color={focused ? colorContext.colorScheme.dhbwRed : colorContext.colorScheme.tabBarText}/>
  }
        ...
        <Tab.Navigator screenOptions={tabsConfig}>
          <Tab.Screen name="DHBW"
                      ...
                      options={{
                        ...
                        tabBarIcon: ({focused}) => <MaterialIcon name={"rss-feed"} size={32} color={focused ? colorContext.colorScheme.dhbwRed : colorContext.colorScheme.tabBarText}/>
                      }}/>
          {enableStuV ? (
              <Tab.Screen name="StuV"
                          ...
                          options={{
                            ...
                            tabBarIcon: ({focused}) => <StuVIcon name={"rss-feed"} width={32} height={32} color={focused ? colorContext.colorScheme.dhbwRed : colorContext.colorScheme.tabBarText}/>
                          }}/>
          ) : null}
          <Tab.Screen
              name="Schedule"

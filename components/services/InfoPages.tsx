...
const AboutBody = () => {
  ...
  return (
    <>
      <InfoText>
        Dies ist die offizielle Campus-App der DHBW Lörrach. Die Umsetzung der
        App erfolgt seit 2015 durch Studierende des Studienzentrums für
        Informatik und IT-Management (SZI) unter der Leitung von Prof. Dr. Erik
        Behrends im Rahmen verschiedener Lehrveranstaltungen.
      </InfoText>
      <InfoText>
...
const ImprintBody = () => (
  <>
    ...
    <InfoText>
      ...
      des öffentlichen Rechts. Sie wird gesetzlich vertreten durch die
      Präsidentin der Dualen Hochschule Baden-Württemberg, Frau Prof. Dr.
      Martina Klärle. Gesetzlicher Vertreter des Hochschulstandorts Lörrach ist
      der Rektor Herr Prof. Gerhard Jäger.
    </InfoText>
    <InfoText>
    ...
    <InfoText>
      ...
      Studienrichtungen, Studienzentren oder Organisationseinheiten
      (Hochschulkommunikation, Bibliothek, usw.) verantwortlich.
    </InfoText>
    <ThemedText style={styles.heading}>Externe Links</ThemedText>
    <InfoText>
      Die DHBW Lörrach Campus App enthält Links zu externen Webseiten Dritter,
...
const DisclaimerBody = () => {
  ...
  return (
    <>
      <InfoText>
        Mit dem ersten Start der DHBW Lörrach Campus App wurde folgender
        Regelung zugestimmt:
      </InfoText>
      <View style={styles.disclaimerContainer}>
        ...
        />
        <InfoText style={styles.disclaimerText}>{disclaimerText}</InfoText>
      </View>
      <InfoText>
        Um diese Zustimmung zurückzuziehen, muss die DHBW Lörrach Campus App auf
...
const FeedbackBody = () => (
  <>
    <InfoText>
      Falls du Fehler oder Verbesserungsvorschläge melden möchtest, dann
...
const PrivacyBody = () => (
  <>
    <InfoText>
      ...
      personenbezogenen Daten eingegeben werden. Der Zugriff auf die Campus App
      der DHBW Lörrach wird durch die App-Stores protokolliert, erfolgt jedoch
      nicht personenbezogen. Damit kann vom Betreiber der App nicht
      nachvollzogen werden, auf welche Seiten einzelne Benutzer zugegriffen bzw.
      welche Funktionen sie genutzt haben.
    </InfoText>
    <InfoText>
